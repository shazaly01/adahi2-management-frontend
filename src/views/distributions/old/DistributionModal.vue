<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="bg-surface-section rounded-lg shadow-xl p-6 w-full max-w-3xl transform"
          role="dialog"
          aria-modal="true"
...
const title = computed(() =>
  props.distribution && props.distribution.id ? 'تحديث مرفقات التوزيع' : 'تنفيذ عملية توزيع جديدة',
)
